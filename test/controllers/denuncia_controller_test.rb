...
class DenunciaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create denuncium" do
    assert_difference('Denuncium.count') do
      post denuncia_url, params: { denuncium: { catalogo: @denuncium.catalogo, descripcion: @denuncium.descripcion, estado: @denuncium.estado, fecha: @denuncium.fecha, latitud: @denuncium.latitud, longitud: @denuncium.longitud } }
    end
  ...
  test "should update denuncium" do
    patch denuncium_url(@denuncium), params: { denuncium: { catalogo: @denuncium.catalogo, descripcion: @denuncium.descripcion, estado: @denuncium.estado, fecha: @denuncium.fecha, latitud: @denuncium.latitud, longitud: @denuncium.longitud } }
