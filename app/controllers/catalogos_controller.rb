class CatalogosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @catalogo.save
        format.html { redirect_to @catalogo, notice: 'Catalogo se ha creado exitosamente.' }
  ...
  def update
    respond_to do |format|
      if @catalogo.update(catalogo_params)
        format.html { redirect_to @catalogo, notice: 'Catalogo se ha actualizado exitosamente.' }
  ...
  def destroy
    @catalogo.destroy
    respond_to do |format|
      format.html { redirect_to catalogos_url, notice: 'Catalogo se ha eliminado exitosamente.' }
  ...
  private
    ...
    def catalogo_params
      params.require(:catalogo).permit(:valor, :descripcion)
    end
end
